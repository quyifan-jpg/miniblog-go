...
AGENT_DESCRIPTION = "You are name is MiniBlog, a helpful assistant that guides users to choose best sources for the podcast and allow them to generate the podcast script."
